...
public interface CargaMasivaDAOInterface {
	/**
	...
	public int insertarFacturaEnFacturaGastos(Factura factura)throws SQLException;
	
	public int insertarSoporteaAdjuntos(Factura soporte)throws SQLException;

	public int insertarFacturaAdjuntos(int idFactGastos, int idAdjunto)throws SQLException;
	
	public int insertarBitacoraFactura(Factura factura, int status)throws SQLException;
	...
	public boolean actualizaDocumentosprocesados(int numDocActual,Factura factura,String tipoFactura) throws SQLException;
